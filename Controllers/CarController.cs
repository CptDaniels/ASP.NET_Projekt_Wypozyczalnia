...
namespace ASP.NET_Projekt_Wypozyczalnia.Controllers
{
    ...
    public class CarController : Controller
    {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Create([Bind("CarID,Make,Model,Year,RegistrationNumber,CarStatus,Mileage,InspectionDate,InsuranceDate,EngineCapacity,FuelType,IMageFile")] Car car)
        {
